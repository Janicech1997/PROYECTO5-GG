...
<section className="noticiasgamer recent-game-section spad set-bg">
  <div className="container">
    ...
    <div className="row">
      ...
      <div className="col-lg-4 col-md-6">
        <div className="recent-game-item">
        <div className="rgi-thumb set-bg"><img src="https://images8.alphacoders.com/627/627080.png" />
      ...
      <div className="col-lg-4 col-md-6">
        <div className="recent-game-item">
          <div className="rgi-thumb set-bg"><img src="https://images8.alphacoders.com/124/1247192.png" />
